...
doAction(client1, 'accuse', table.playerIDs[1])
...
if(table.round.mode != 'accusation') {throw new Error('mode not accusation')}
...
doAction(client2, 'accuse', table.playerIDs[3])
await new Promise( (resolve) => {setTimeout(resolve, 300)})
if(table.round.mode != 'lastChance') {throw new Error('mode not lastChance')}
doAction(client2, 'accuse', table.playerIDs[0])
await waitFor('playerAccused')
doAction(client2, 'cancelAccusation')
await waitFor('accusationCancelled')
if(table.round.mode != 'lastChance') {throw new Error('mode not lastChance')}
